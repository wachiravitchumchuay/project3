...
public class GetAllRecommendationRequest {
    ...
    public static class BudgetInteresets {
        ...
        /**
         * Gets the value of the budgetIntereset property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the Jakarta XML Binding object.
         * This is why there is not a <CODE>set</CODE> method for the budgetIntereset property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getBudgetIntereset().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<String> getBudgetIntereset() {
            if (budgetIntereset == null) {
                budgetIntereset = new ArrayList<String>();
            }
            return this.budgetIntereset;
        }
