...
public class GetAllRecommendationResponse {
    ...
    public static class RunningEvents {
        ...
        protected List<GetAllRecommendationResponse.RunningEvents.TravelPlaces> travelPlaces;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link GetAllRecommendationResponse.RunningEvents.TravelPlaces }
         * 
         * 
         */
        public List<GetAllRecommendationResponse.RunningEvents.TravelPlaces> getTravelPlaces() {
            if (travelPlaces == null) {
                travelPlaces = new ArrayList<GetAllRecommendationResponse.RunningEvents.TravelPlaces>();
            }
            return this.travelPlaces;
        }
