...
@XmlRootElement(name = "getAllRestaurantResponse")
public class GetAllRestaurantResponse {

    protected List<GetAllRestaurantResponse.Restaurants> restaurants;
     ...
     * {@link GetAllRestaurantResponse.Restaurants }
     * 
     * 
     */
    public List<GetAllRestaurantResponse.Restaurants> getRestaurants() {
        if (restaurants == null) {
            restaurants = new ArrayList<GetAllRestaurantResponse.Restaurants>();
        }
